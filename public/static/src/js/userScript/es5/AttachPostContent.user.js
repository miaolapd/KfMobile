...
(function () {
    ...
    if (action === 'modify') return;else if (options.attachType === 1 && (pageId === 'readPage' || action === 'reply' || action === 'quote')) return;else if (options.attachType === 2 && pageId === 'postPage' && !action) return;

    var $form = $('#postForm');
    $form.submit(function () {
        var $this = $(this);
        var $postContent = $this.find('#postContent');
